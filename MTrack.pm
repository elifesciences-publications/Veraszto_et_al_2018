...
sub ReadTracks2
{
	...
	while (defined (my $line = <TRACKS_IN>))
	{
		...
		# Stop looking for data if we encounter the distance traveled section:
...
sub ReadDistances2
{
	...
	while (defined (my $line = <TRACKS_IN>))
	{
		...
		{
			# Scan the file until we reach the distance traveled section and then we parse the distances
